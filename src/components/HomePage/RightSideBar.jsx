...
const RightSideBar = () => {
  return (
    <div className="mx-auto col-span-full w-full lg:col-span-1">
      <h2 className="text-xl text-[#403F3F] font-semibold mb-5">Login With</h2>
      <div className="flex flex-col gap-3">
        {/* Google */}
        <button className="btn w-full text-blue-600 border-2 border-blue-500">
          <svg
      ...
      <div className="">
        <h2 className="text-xl text-[#403F3F] font-semibold mb-5 mt-10">
          Find Us On
        </h2>
        <div className="flex flex-col gap-3">
          <button className="btn justify-start  border">
            <svg
        ...
        <div className="p-4 mt-10 bg-[#F3F3F3] flex flex-wrap justify-content lg:flex-col">
          <h2 className="text-xl text-[#403F3F] font-semibold mb-5 ">Q-Zone</h2>
          <div className="p-4">
            <Image src={SwimmingImage} alt="Swimming" />
          </div>
          <div className="p-4">
            <Image src={ClassImage} alt="Swimming" />
          </div>
          <div className="p-4">
            <Image src={Playground} alt="Playground" />
          </div>
          <div className="p-4">
            <Image src={BgImage} alt="Playground" />
          </div>
        </div>
      </div>
    </div>
